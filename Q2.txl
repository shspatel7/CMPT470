...
define program
    ...
    | [single_include] [NL] [single_define] [NL] [c_function]
    | [single_include] [NL] [multi_define] [NL] [c_function]
    | [multi_include] [NL] [c_function]
    | [multi_include] [NL] [single_define] [NL] [c_function]
    | [multi_include] [multi_define] [NL] [c_function]
end define
...
define single_define
    [define_files] [NL]
end define

define multi_define
    [repeat single_define]
end define
